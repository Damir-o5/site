...
class Menu(db.Model):
    ...
    slug = db.Column(db.String(64), unique=True, nullable=False)   # main, bar, wine
...
class Category(db.Model):
    ...
    slug = db.Column(db.String(64), unique=True, nullable=False)  # machine id/slug
...
class Dish(db.Model):
    ...
    slug = db.Column(db.String(128), unique=True, nullable=False)  # machine id
